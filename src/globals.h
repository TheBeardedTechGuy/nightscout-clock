...
#define COLOR_DIMMER_TIMER_BLOCK 0x07E0
#define COLOR_DIMMER_TIMER_BLOCK_WARNING COLOR_YELLOW
#define COLOR_DIMMER_TIMER_BLOCK_OLD COLOR_WHITE
#define DIMMER_BG_COLOR_OLD COLOR_WHITE
#define DIMMER_MIN_BRIGHTNESS 1
#define DIMMER_MAX_BRIGHTNESS 180
#define BRIGHTER_MIN_BRIGHTNESS 25
#define BRIGHTER_MAX_BRIGHTNESS 200
